...
const Signup = () => {
  ...
  return (
    ...
    >
      <section className="relative w-full h-full flex items-center overflow-x-hidden">
        {/* Card 2 - behind */}
            ...
            <div className="">
              <form action="#" className="">
                {!isContinue ? (
                  ...
                  <div className="flex flex-col px-10 gap-1">
                    <label htmlFor="domain" className={"pl-2"}>
                      Domain
                    </label>
                    <input
                      type="text"
                    ...
                    <label htmlFor="skills" className={"pl-2"}>
                      Skills
                    </label>
                    <input
                      type="text"
                    ...
                    <label htmlFor="photo" className={"pl-2"}>
                      Profile Photo
                    </label>
                    <input
                      type="text"
                    ...
                    <label htmlFor="about" className={"pl-2"}>
                      Bio
                    </label>
                    <textarea
                      type="text"
                      ...
                      id="about"
                      name="about"
                      className="px-2 py-2 h-32 border border-zinc-500 outline-none rounded-sm mb-6 focus-within:border-zinc-400 resize-none"
                    />
